 ...
 $.fn.imgcode = function (options) { 
  ...
  return this.each(function () { 
   ...
   var html = '<div class="code-k-div">' + 
    ...
    '<div class="code-mask"><img src="img/spt.png"></div>' + 
    '<img src="img/bpt.png"></div>' + 
    ...
    '</div>'+
    '<input type="text" value="下一步"/>'+"</div></div>"; 
   $this.html(html); 
   ...
   function checkcode(code){ 
    ...
    setTimeout(function(){ 
     if(iscur){ 
      ...
      checkcoderesult(1,"认证成功"); 
      $this.find(".code-k-div").hide(); 
      $("span:last").html("认证成功")
     }else{ 
      $divMove.addClass("error");  
      $("span:last").html("认证成功").css("color","#fff").parent().css("background","blue")
       $("span:last").siblings().css("display","none")
      setTimeout(function() { 
